...
[![test prune script](https://github.com/jonlabelle/docker-magika/actions/workflows/test-prune-script.yml/badge.svg)](https://github.com/jonlabelle/docker-magika/actions/workflows/test-prune-script.yml)
...
python main.py --container magika --registry dockerhub --prune-all-untagged --dry-run --verbose
```
